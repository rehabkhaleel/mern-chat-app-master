...
const Conversation = ({ conversation, lastIdx, emoji }) => {
    ...
    return (
        <>
            <div
                className={`flex gap-2 items-center text-black hover:bg-sky-600 hover:text-white rounded p-2 py-1 cursor-pointer
            ...
            >
                ...
                <div className='flex flex-col flex-1'>
                    <div className='flex gap-3 justify-between'>
                        <p className='font-bold text-black hover:text-white'>{conversation.name}</p>
